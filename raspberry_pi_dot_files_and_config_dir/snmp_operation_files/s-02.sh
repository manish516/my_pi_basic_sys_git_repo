...
PLACE=".1.3.6.1.4.1.8516.1.2" # OID 
REQ="$2" # Requested OID
#
...
case "$REQ" in
  ...
  $PLACE.3) val_3=$4;[ $val_3 = "a" ] && echo "s-02-power" > $val_str_f; exit 0 ;;
  $PLACE.4) val_4=$4;[ $val_4 = "a" ] && echo "s-02-mute" > $val_str_f; exit 0 ;;
  $PLACE.5) val_5=$4;[ $val_5 = "a" ] && echo "s-02-VOL_up" > $val_str_f; exit 0 ;;
  $PLACE.6) val_6=$4;[ $val_6 = "a" ] && echo "s-02-VOL_down" > $val_str_f; exit 0 ;;
  $PLACE.7) val_7=$4;[ $val_7 = "a" ] && echo "s-02-CH_up" > $val_str_f; exit 0 ;;
  $PLACE.8) val_8=$4;[ $val_8 = "a" ] && echo "s-02-CH_down" > $val_str_f; exit 0 ;;
  $PLACE.9) val_9=$4;[ $val_9 = "a" ] && echo "s-02-CH_1" > $val_str_f; exit 0 ;;
  $PLACE.10) val_10=$4;[ $val_10 = "a" ] && echo "s-02-CH_2" > $val_str_f; exit 0 ;;
  $PLACE.11) val_11=$4;[ $val_11 = "a" ] && echo "s-02-CH_3" > $val_str_f; exit 0 ;;
  $PLACE.12) val_12=$4;[ $val_12 = "a" ] && echo "s-02-CH_4" > $val_str_f; exit 0 ;;
  $PLACE.13) val_13=$4;[ $val_13 = "a" ] && echo "s-02-CH_5" > $val_str_f; exit 0 ;;
  $PLACE.14) val_14=$4;[ $val_14 = "a" ] && echo "s-02-CH_6" > $val_str_f; exit 0 ;;
  $PLACE.15) val_15=$4;[ $val_15 = "a" ] && echo "s-02-CH_7" > $val_str_f; exit 0 ;;
  $PLACE.16) val_16=$4;[ $val_16 = "a" ] && echo "s-02-CH_8" > $val_str_f; exit 0 ;;
  $PLACE.17) val_17=$4;[ $val_17 = "a" ] && echo "s-02-CH_9" > $val_str_f; exit 0 ;;
  $PLACE.18) val_18=$4;[ $val_18 = "a" ] && echo "s-02-CH_0" > $val_str_f; exit 0 ;;
  $PLACE.19) val_19=$4;[ $val_19 = "a" ] && echo "s-02-Left" > $val_str_f; exit 0 ;;
  $PLACE.20) val_20=$4;[ $val_20 = "a" ] && echo "s-02-Right" > $val_str_f; exit 0 ;;
  $PLACE.21) val_21=$4;[ $val_21 = "a" ] && echo "s-02-Up" > $val_str_f; exit 0 ;;
  $PLACE.22) val_22=$4;[ $val_22 = "a" ] && echo "s-02-Down" > $val_str_f; exit 0 ;;
  $PLACE.23) val_23=$4;[ $val_23 = "a" ] && echo "s-02-Select" > $val_str_f; exit 0 ;;
  $PLACE.24) val_24=$4;[ $val_24 = "a" ] && echo "s-02-Menu" > $val_str_f; exit 0 ;;
...
case "$RET" in
  ...
  $PLACE.3) echo "string"; echo "s-02-power"; exit 0 ;;
  $PLACE.4) echo "string"; echo "s-02-mute"; exit 0 ;;
  $PLACE.5) echo "string"; echo "s-02-VOL_up"; exit 0 ;;
  $PLACE.6) echo "string"; echo "s-02-VOL_down"; exit 0 ;;
  $PLACE.7) echo "string"; echo "s-02-CH_up"; exit 0 ;;
  $PLACE.8) echo "string"; echo "s-02-CH_down"; exit 0 ;;
  $PLACE.9) echo "string"; echo "s-02-CH_1"; exit 0 ;;
  $PLACE.10) echo "string"; echo "s-02-CH_2"; exit 0 ;;
  $PLACE.11) echo "string"; echo "s-02-CH_3"; exit 0 ;;
  $PLACE.12) echo "string"; echo "s-02-CH_4"; exit 0 ;;
  $PLACE.13) echo "string"; echo "s-02-CH_5"; exit 0 ;;
  $PLACE.14) echo "string"; echo "s-02-CH_6"; exit 0 ;;
  $PLACE.15) echo "string"; echo "s-02-CH_7"; exit 0 ;;
  $PLACE.16) echo "string"; echo "s-02-CH_8"; exit 0 ;;
  $PLACE.17) echo "string"; echo "s-02-CH_9"; exit 0 ;;
  $PLACE.18) echo "string"; echo "s-02-CH_0"; exit 0 ;;
  $PLACE.19) echo "string"; echo "s-02-Left"; exit 0 ;;
  $PLACE.20) echo "string"; echo "s-02-Right"; exit 0 ;;
  $PLACE.21) echo "string"; echo "s-02-Up"; exit 0 ;;
  $PLACE.22) echo "string"; echo "s-02-Down"; exit 0 ;;
  $PLACE.23) echo "string"; echo "s-02-Select"; exit 0 ;;
  $PLACE.24) echo "string"; echo "s-02-Menu"; exit 0 ;;
